...
Como estudante de **Análise e Desenvolvimento de Sistemas (ADS)**, desenvolvi esta API para substituir controles manuais por uma solução automatizada que garante a integridade do inventário e a formalização das responsabilidades de uso.
...
Bash
git clone [https://github.com/AlmirLima150/gestao-patrimonio.git](https://github.com/AlmirLima150/gestao-patrimonio.git)
